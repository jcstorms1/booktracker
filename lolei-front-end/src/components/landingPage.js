  ...
  return (
    <div className="center-div">
      <Grid.Column verticalAlign="middle" textAlign="center">
        <Header style={{ fontFamily: "Schoolbell" }} textAlign="center" as="h1">
          Welcome To
        </Header>
        ...
        <Header
          ...
          as="h3"
          content="Lo lei translates to `I read it` in Spanish, and here at Lolei,
        ...
        <div>
          <Button.Group fluid id="landing-buttons">
            <Button id="login-btn" onClick={props.logInButton}>
              Login
            </Button>
            <Button.Or id="or-btn" />
            <Button id="signup-btn" align="center" onClick={props.signUpButton}>
              Sign Up
            </Button>
          </Button.Group>
        </div>
