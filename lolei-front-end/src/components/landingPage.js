...
const LandingPage = props => {
	return (
		<div className="center-div">
			<Image src={logo}/>
			<Header style={{fontFamily: 'Schoolbell'}} textAlign='center' as='h1'>Welcome to LoLei!
				<Header style={{fontFamily: 'Schoolbell'}} as='h3' content=
			...
			<Grid.Column verticalAlign='middle' centered textAlign='center'>
				<Button.Group id='landing-buttons'>
					<Button fluid id='login-btn' onClick={props.logInButton}>Login</Button>
						<Button.Or id='or-btn' />
					<Button fluid id='signup-btn' align='center' onClick={props.signUpButton}>Sign Up</Button>
				</Button.Group>
			</Grid.Column>
		</div>
	)
