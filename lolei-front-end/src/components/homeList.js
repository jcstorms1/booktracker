...
const HomeList = props => {
	return (
		<div className="card-deck" style={{ marginTop: '100px'}}>
			...
			<div className="card">
				<img className="card-img-top" src="https://images-na.ssl-images-amazon.com/images/I/51wYUOlClbL._SL160_.jpg" alt="Card cap"/>
				<div className="card-block">
			...
			<div className="card">
				<img className="card-img-top" src="https://images-na.ssl-images-amazon.com/images/I/51NZAJGdUPL._SL160_.jpg" alt="Card cap"/>
				<div className="card-block">
